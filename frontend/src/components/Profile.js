...
function Profile() {
  ...
  useEffect(() => {
    ...
    axios.get(`http://127.0.0.1:8000/api/employee/${user.emp_id}/`)
  ...
  const initials = (data.name || "E").split(" ").map(w => w[0]).join("").slice(0, 2).toUpperCase();
    ...
    <div className="profile-page">
      ...
      <div className="profile-sections">
        ...
        <div className="profile-card">
          ...
          <div className="profile-grid">
            {[
              ...
              ["Salary",          <span className="profile-field-value salary">{data.salary || "—"}</span>],
        ...
        <div className="profile-card">
          ...
          <div className="profile-grid">
            {[
              ["Work Permit No", <span className="profile-field-value mono">{data.work_permit_no || "—"}</span>],
              ["WP Expiry",      val(data.wp_expiry)],
              ["FIN No",         <span className="profile-field-value mono">{data.fin_no || "—"}</span>],
        ...
        <div className="profile-card">
          ...
          <div className="profile-grid">
            {[
              ["Passport No",   <span className="profile-field-value mono">{data.passport_no || "—"}</span>],
