    ...
    <div className="detail-page">
      ...
      <div className="detail-sections">
        ...
        <Section title="Passport" icon="🛂">
          ...
          <Field
            label="Expiry"
            value={<ExpiryVal date={emp.passport_expiry} />}
          />
        ...
        <Section title="Security Bond" icon="🔐">
          ...
          <Field
            label="Bond Expiry"
            value={<ExpiryVal date={emp.security_bond_exp} />}
          />
        </Section>
        ...
        <Section title="Certifications & Skills" icon="🏅" wide>
          ...
          <Field
            ...
            value={<ExpiryVal date={emp.ssic_gt_exp} />}
          />
          <Field label="SSIC HT S/N" value={val(emp.ssic_ht_sn)} />
          <Field
            label="SSIC HT Expiry"
            value={<ExpiryVal date={emp.ssic_ht_exp} />}
          />
          <Field label="Dynamac Pass S/N" value={val(emp.dynamac_pass_sn)} />
          <Field
            label="Dynamac Expiry"
            value={<ExpiryVal date={emp.dynamac_pass_exp} />}
          />
          <Field label="LSSC S/N" value={val(emp.lssc_sn)} />
          <Field label="Welder No" value={val(emp.welder_no)} />
          <Field
            label="Work At Height"
            value={<BoolBadge v={emp.work_at_height} />}
          />
          <Field
            label="Confined Space"
            value={<BoolBadge v={emp.confined_space} />}
          />
          <Field
            label="Signalman/Rigger"
            value={<BoolBadge v={emp.signalman_rigger} />}
          />
          <Field
            label="Firewatchman"
            value={<BoolBadge v={emp.firewatchman} />}
          />
          <Field
            label="Gas Meter Carrier"
            value={<BoolBadge v={emp.gas_meter_carrier} />}
          />
        </Section>
